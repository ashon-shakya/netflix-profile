    ...
    <>
      ...
      >
        ...
        <div className="group relative flex-shrink-0 w-55 hover:w-110 h-72 rounded-lg  cursor-pointer transition-all duration-300 overflow-hidden">
          ...
          <div className="absolute top-0 left-0 w-full h-full bg-black/95 backdrop-blur-lg opacity-0 group-hover:opacity-95 transition-opacity duration-300 flex flex-col justify-center items-center p-4 text-center">
